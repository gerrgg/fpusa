...
<form class="woocommerce-cart-form row" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="col-9">
		<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table border-bottom" cellspacing="0">
			<thead>
				<tr>
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							if ( ! $product_permalink ) {
								...
								printf( '<a class="product-image-link product-image-link-sm" href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail ); // PHPCS: XSS ok.
							}
							?>
							</td>
